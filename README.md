# Aprendizado em Python - Jornada na Lógica de Programação
...
1. Tento resolver sozinha (15-20 min)

2. Analiso a solução quando necessário

3. Documento com meus comentários (fixando o aprendizado)
