...
print(f"Seu primeiro nome é {nome[0]}, e o último é {nome[- 1]}.") # ou nome[len(nome) - 1] pois o len irá contar cada nome que foi separado pelo split e viraram uma lista, as listas
